...
1. Clone this repo:
```bash
git clone https://github.com/McLabGalaxy/mlops-workflow-kestra.git
```
2. Go to the folder:
```bash
...
docker-compose up -d
```
Access the UI by opening the URL http://0.0.0.0:8080 in your browser.

![](images/kestra.png)


## Run the flow
see ketra for more info on how to run a workflow.
